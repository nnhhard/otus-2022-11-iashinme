...
import ru.iashinme.homework16.dto.*;
...
public class BookServiceImplTest {
    ...
    @DisplayName("возвращать статус при запросе о существовании книг")
    @Test
    void shouldReturnExistsBook() {
        when(bookRepository.existsBy()).thenReturn(true);

        boolean existsBook = bookService.existsBook();

        assertThat(existsBook)
                .isEqualTo(true);
    }
